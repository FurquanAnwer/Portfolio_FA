...
const projectsData = [
  ...
  },
  {
    ...
    description: "A Next.js-based Image Editor that lets users upload, edit, and manage images in real time. Powered by ImageKit for optimization, Neon for scalable storage, Better Auth for secure access, and Polar for subscriptions — delivering a fast, modern, and seamless in-browser editing experience.",
